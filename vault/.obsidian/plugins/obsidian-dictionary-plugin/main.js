...
=======
/* src/ui/settings/infoModal.svelte generated by Svelte v3.40.3 */
...
function add_css$5(target) {
=======
/* src/ui/dictionary/phoneticComponent.svelte generated by Svelte v3.40.3 */
...
=======
			if (!src_url_equal(source.src, source_src_value = /*audio*/ ctx[1])) attr(source, "src", source_src_value);
>>>>>>> Stashed changes
...
function add_css$4(target) {
=======
		init(this, options, instance$4, create_fragment$4, safe_not_equal, { text: 0, audio: 1 }, add_css$4);
	}
}

/* src/ui/dictionary/meaningComponent.svelte generated by Svelte v3.40.3 */
...
function create_fragment$3(ctx) {
=======
		init(this, options, instance$3, create_fragment$3, safe_not_equal, { word: 0, definitions: 1, partOfSpeech: 2 }, add_css$3);
	}
}

/* src/ui/dictionary/errorComponent.svelte generated by Svelte v3.40.3 */
...
=======
		init(this, options, instance$2, create_fragment$2, safe_not_equal, { error: 0 }, add_css$2);
	}
}

/* src/ui/dictionary/dictionaryView.svelte generated by Svelte v3.40.3 */
>>>>>>> Stashed changes
...
function create_if_block_3(ctx) {
=======
// (54:10) {#if data.phonetics.first().text}
...
=======
// (57:14) {#each data.phonetics as { text, audio }}
>>>>>>> Stashed changes
...
=======
// (64:12) {#each data.meanings as { definitions, partOfSpeech }}
>>>>>>> Stashed changes
...
=======
// (47:20)        <div class="center">         <div class="spinner" />       </div>     {:then data}
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
        ...
        this.offline = true;
=======
        this.url = "Offline, downloaded from GitHub Release on first use.";
        this.supportedLanguages = ["en_US", "en_GB", "cn"];
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
            ...
            return json.first();
=======
            const json = (_a = (yield JSON.parse(result))) === null || _a === void 0 ? void 0 : _a.first();
            if (!json) {
...
class SynonymoSynonymAPI {
    constructor() {
        ...
        this.API_END_POINT = 'http://www.synonymo.fr/synonyme/';
    }
    /**
     * @param query - The term you want to look up
     * @returns Returns the URL in REST schema
...
=======
                result = yield obsidian.request({ url: this.constructRequest(query, lang) });
>>>>>>> Stashed changes
            }
            catch (error) {
                return Promise.reject(error);
...
=======
/* src/ui/synonyms/synonymPopover.svelte generated by Svelte v3.40.3 */
>>>>>>> Stashed changes
...
=======
            ...
            const contents = settings.template
                ...
                .replace(/{{meanings}}/ig, meanings);
            try {
                file = yield plugin.app.vault.create(path, contents);
>>>>>>> Stashed changes
