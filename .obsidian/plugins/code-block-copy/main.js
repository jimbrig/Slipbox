...
var CMSyntaxHighlightPlugin = /** @class */ (function (_super) {
    ...
    function CMSyntaxHighlightPlugin(app, pluginManifest) {
    ...
    CMSyntaxHighlightPlugin.prototype.injectButtons = function () {
        this.addCopyButtons(navigator.clipboard);
    };
    CMSyntaxHighlightPlugin.prototype.addCopyButtons = function (clipboard) {
        document.querySelectorAll('pre > code').forEach(function (codeBlock) {
            var pre = codeBlock.parentNode;
            // check for excluded langs
            for (var _i = 0, excludeLangs_1 = excludeLangs; _i < excludeLangs_1.length; _i++) {
                var lang = excludeLangs_1[_i];
